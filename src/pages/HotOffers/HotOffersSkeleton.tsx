  ...
  return (
    <div className="space-y-8 pb-8">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="rounded-[24px] border border-primary-border bg-white overflow-hidden"
            >
              <Skeleton.Image
                active
                className="!aspect-[3/2] !w-full !min-h-[120px]"
              />
              <div className="p-3 md:p-4">
                <Skeleton.Input
                  active
                  className="!mb-2 !h-5 !w-full !min-w-0"
                />
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="flex items-center gap-4 rounded-lg border border-primary-border bg-white p-4"
            >
              <Skeleton.Avatar
                active
                size={56}
      ...
      <section>
        ...
        <div className="rounded-[24px] border border-primary-border bg-white p-5 md:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
          {[1, 2, 3, 4].map((i) => (
            ...
            >
              <Skeleton.Image
                active
                className="!aspect-[3/2] !w-full !min-h-[100px]"
              />
              <div className="p-3 md:p-4">
                <Skeleton.Input
                  active
      ...
      {/* Banner */}
      <section className="rounded-2xl overflow-hidden border border-primary-border bg-neutral-50">
        <div className="flex flex-col md:flex-row min-h-[140px]">
          <div className="flex-1 p-5 md:p-6 flex flex-col justify-center gap-2">
            ...
            <Skeleton.Input
              active
              className="!h-4 !w-full !max-w-md !min-w-0"
            />
            <Skeleton.Input
              active
              className="!h-4 !w-[75%] !max-w-sm !min-w-0"
            />
