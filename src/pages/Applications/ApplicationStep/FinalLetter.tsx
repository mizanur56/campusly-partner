    ...
    () => [
      {
        ...
        description: "Your documents has been submitted, you documents under review, we will send it to the college.",
        isCompleted: !!loaUrl,
        url: loaUrl,
    ...
    <>
      <div className="border border-[#C7CACF] rounded-lg overflow-hidden">
        <div className="bg-[#E9F2EB] p-6 flex items-center justify-between">
          <div>
            <h3 className="text-[20px] font-semibold text-[#20242A]">Final Letter</h3>
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between border border-[#D1D5DB] rounded-lg p-4 w-fit min-w-70">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-[14px] font-medium text-[#20242A]">{section.documentName}.pdf</p>
                          <p className="text-[12px] text-[#6B7280]">
                            {section.id === "loa" ? (fileSizes.acceptanceLetter || "—") : (fileSizes.moneyReceipt || "—")}
                          </p>
                        </div>
                      </div>
      ...
      <div className="flex justify-end gap-3 pt-4">
        <button onClick={() => navigate(`/applications/${id}/checklist`)} className="px-6 py-2 border border-[#D1D5DB] rounded-lg text-[#237D3B] font-semibold hover:bg-gray-50 transition">
          Previous
        </button>
