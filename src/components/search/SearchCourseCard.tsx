...
export default function SearchCourseCard({
  ...
  return (
    <Link
      to={href}
      className={`group flex flex-col gap-3 sm:gap-4 rounded-[24px] border border-primary-border bg-white p-4 md:p-5 shadow-[0_1px_2px_rgba(0,0,0,0.02)] h-full w-full transition-all duration-200 hover:-translate-y-0.5 hover:border-primary-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.06)] cursor-pointer ${className}`}
    >
      ...
      <div className="flex items-center gap-3">
        {course?.image ? (
          <div className="flex h-10 w-10 sm:h-11 sm:w-11 shrink-0 items-center justify-center overflow-hidden rounded-lg border border-primary-border bg-neutral-50/80">
            <img
          ...
          <div className="flex h-10 w-10 sm:h-11 sm:w-11 shrink-0 items-center justify-center rounded-lg bg-neutral-50 border border-primary-border text-neutral-400">
            <svg
