...
const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-[var(--fynix-bg)] shadow-[0_4px_20px_-8px_rgba(26,29,31,0.08)]">
      <div className="relative flex w-full items-center justify-between gap-4 px-3 py-4 pl-14 sm:px-4 sm:pl-6 lg:px-4">
        {/* Left — page title */}
        <div className="min-w-0 flex-1">
          <h1 className="truncate text-sm font-bold leading-tight text-[var(--fynix-text)] sm:text-base lg:text-lg">
            Welcome back, {user?.name?.split(" ")[0] || "Admin"}! 👋
          </h1>
          <p className="mt-0.5 hidden truncate text-xs text-[var(--fynix-muted)] sm:block">
        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-3">
          <div className="hidden w-[200px] sm:block lg:w-[220px]">
            <form className="relative" onSubmit={(e) => e.preventDefault()}>
              <span className="pointer-events-none absolute left-3 top-1/2 z-[1] -translate-y-1/2 text-fynix-muted">
                <svg
                  className="h-4 w-4"
                  fill="none"
                  stroke="currentColor"
              ...
              <input
                ...
                type="search"
                placeholder="Search..."
                className="h-10 w-full rounded-[6px] border-0 bg-surface py-2 pl-9 pr-14 text-sm text-fynix-text shadow-sm placeholder:text-fynix-muted focus:outline-none focus:ring-2 focus:ring-[#95d66d]/30"
              />
              <span className="pointer-events-none absolute right-2.5 top-1/2 hidden -translate-y-1/2 items-center gap-0.5 rounded-[6px] border border-surface-border-subtle bg-fynix-bg px-1.5 py-0.5 text-[10px] text-fynix-muted lg:flex">
          ...
          <button
            type="button"
            onClick={handleFullscreen}
            className="group relative hidden cursor-pointer h-10 w-10 items-center justify-center rounded-[6px] border border-surface-border bg-surface text-fynix-muted shadow-sm transition-all duration-300 hover:border-primary-500 hover:text-primary-600 hover:shadow-md md:flex lg:h-11 lg:w-11"
          ...
          <Link
            to="/settings"
            className="hidden h-10 w-10 items-center justify-center rounded-[6px] bg-surface text-fynix-muted shadow-sm transition hover:text-[#95d66d] sm:flex lg:h-11 lg:w-11"
            aria-label="Settings"
          >
          ...
          <button
            type="button"
            className="hidden h-10 cursor-pointer w-10 items-center justify-center rounded-[6px] bg-surface text-fynix-muted shadow-sm transition hover:text-[#95d66d] md:flex lg:h-11 lg:w-11"
            aria-label="Help"
          >
      ...
      {/* Mobile menu toggle */}
      <button
        className="absolute left-4 top-1/2 z-50 -translate-y-1/2 rounded-xl p-2 text-fynix-muted hover:bg-surface lg:hidden"
        onClick={handleToggle}
        aria-label="Toggle Sidebar"
      >
        {isMobileOpen ? (
