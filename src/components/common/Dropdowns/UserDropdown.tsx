  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative cursor-pointer flex items-center justify-center w-11 h-11 text-gray-500 transition-colors bg-white border border-gray-100 rounded-full dropdown-toggle hover:text-gray-700 hover:bg-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:hover:bg-gray-800 dark:hover:text-white"
