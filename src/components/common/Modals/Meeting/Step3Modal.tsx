...
const Step3Modal: React.FC<Step3ModalProps> = ({ open, onClose, date, time }) => {
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-6 text-center">
          <div className="space-y-2">
            <h2 className="text-2xl font-bold text-gray-900">Session Confirmed</h2>
            <p className="text-gray-600">
              The link to join the session will be emailed to you
            </p>
          </div>

          <div className="w-full space-y-4 rounded-lg border border-[#C7CACF] bg-[#FFFFFF] p-4">
            <div className="flex items-center gap-4">
              <div className="flex flex-col items-center rounded-lg border border-[#C7CACF] bg-[#FAFAFA]">
              ...
              <div className="flex-1 text-left">
                <p className="text-lg font-semibold text-gray-900">Counselling Session</p>
          ...
          <div className="flex w-full justify-end pt-4">
            <PrimaryButton variant="primary" size="md" onClick={onClose} className="px-8">
              Done
            </PrimaryButton>
          </div>
        </div>
